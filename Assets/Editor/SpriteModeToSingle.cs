...
public static class SpriteModeToSingle
{
    [MenuItem("Tools/Sprites/스프라이트 모드를 Single로 설정")]
    public static void SetSpriteModeToSingle()
    {
    ...
    [MenuItem("Tools/Sprites/스프라이트 모드를 Single로 설정", true)]
    private static bool ValidateSetSpriteModeToSingle()
    {
